...
@testset "cloud data" begin
    ...
    @testset "data integrity" begin
        ...
        @test isempty(cloud_empty)
        @test isempty(cloud_nothing)
    ...
    @testset "constructors" begin
        ...
        @test track == cloud.tracks[1]
        @test track64 == cloud64.tracks[1]
        @test track_converted ≈ cloud64.tracks[1] atol = 1e-5
        @test track_empty isa CloudData{Float32}
        @test isempty(track_empty)
        @test cloudtrack isa CloudData{Float32}
        @test cloudtrack == track
